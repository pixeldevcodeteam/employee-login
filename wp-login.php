...
function login_header( $title = null, $message = '', $wp_error = null ) {
	...
	<style>
		...
		.loginContainer div#login .loginContainer {
			height: 100%;
			width: 100%;
			display: unset;
			align-items: center;
		...
		.loginContainer div#login .loginContainer h1 {
			margin-top: 30px;
			position: absolute;
			text-align: center;
			width: 100%;
		}
		.loginContainer div#login.active .loginContainer {
			transform: translate(0%);
		}
		.loginContainer div#login .loginContainer .loginContent {
			text-align: center;
		}
		...
		.LoginContentContainer {
			...
			align-items: center;
			justify-content: center;
			/* background: url(/Codenimo-login/wp-content/uploads/2024/10/contemporary-room-workplace-office-supplies-concept-scaled.jpg); */
			position: relative;
			background-repeat: no-repeat;
			padding: 0 20px;
		}
		.LoginContentContainer video#myVideo {
			position: absolute;
			width: 100%;
			height: 100%;
			object-fit: cover;
		}
		.LoginContentContainer:before {
			content: '';
			background: #0b192c85;
			height: 100%;
			top: 0;
		...
		.LoginContentContainer .loginContainer div#login form#loginform {
		...
		.loginContainer div#login h1 img {
			max-width: 100px;
			width: 100%;
			height: 100px;
		}
		.LoginContentContainer .loginContainer div#login form#loginform label,
		div#signup .registerformContainer form label {
		...
		div#signup .registerformContainer .txtContent h3 {
			font-size: 32px;
			color: #407de8;
			margin: 10px 0 32px 0;
		}
		.LoginContentContainer .loginContainer div#login form#loginform p:nth-child(1) {
			order: 1;
		}
		.LoginContentContainer .loginContainer div#login form#loginform .user-pass-wrap {
			order: 2;
		}
		.LoginContentContainer .loginContainer div#login form#loginform p.forgetmenot {
			order: 4;
			margin-top: 20px;
		}
		.LoginContentContainer .loginContainer div#login form#loginform p.submit {
			order: 3;
			margin-top: 7px;
		}
		.LoginContentContainer .loginContainer div#login form#loginform p.submit input#wp-submit,
		div#signup .registerformContainer form input[type="submit"] {
			width: 100%;
			font-size: 15px;
			font-weight: 600;
			text-transform: uppercase;
		...
		div#signup .registerformContainer form input[type="submit"]:hover {
			background: #135e96;
			border-color: #135e96;
		}
		div#signup .registerformContainer form > p {
			display: flex;
			flex-direction: column;
		}
		div#signup .registerformContainer form input {
			margin-bottom: 15px;
			min-height: 40px;
			font-size: 15px;
		}
		.LoginContentContainer .loginContainer div#login form#loginform p:nth-child(1) input,
		.LoginContentContainer .loginContainer div#login form#loginform .user-pass-wrap input#user_pass{
			font-size: 15px;
		}
		.loginContainer div#login a.wp-login-lost-password,
		.loginContainer div#login a.wp-login-log-in{
			color: white;
			font-size: 14px;
		...
		.loginContainer div#login p#nav {
		text-align: center;
		margin-top: 0;
		}
		.loginContainer div#login p#backtoblog {
			display: inline;
		}
		.loginContainer div#login p#backtoblog a {
			font-size: 14px;
			color: white;
		}
		.loginContainer div#signup {
			display: flex;
			align-items: center;
			justify-content: center;
			position: relative;
		...
		.loginContainer div#signup .signupContainer {
			height: 100%;
			width: 100%;
			display: flex;
			align-items: center;
		...
		.loginContainer div#signup.active .signupContainer{
		...
		.loginContainer div#signup .signupContainer .signupContent {
			text-align: center;
			margin-bottom: 5px;
		}
		.loginContainer div#signup .signupContainer .signupContent p,
		.loginContainer div#login .loginContainer .loginContent p{
			margin-bottom: 10px;
			font-size: 15px;
			color: white;
		}
		...
		.loginContainer div#signup .signupContainer .signupContent h2,
		.loginContainer div#login .loginContainer .loginContent h2 {
			font-size: 32px;
			color: white;
		}
		.loginContainer div#signup .signupContainer .signupContent button,
		.loginContainer div#login .loginContainer .loginContent button
		 {
		...
		div#signup .registerformContainer form {
			border: 0;
			box-shadow: none;
			background: none;
			padding: 0;
	...
	<!-- New Css For Login End -->
	<div class="LoginContentContainer">
	<video autoplay="" muted="" loop="" id="myVideo">
  <source src="/Codenimo-login/wp-content/uploads/2024/10/1477026_Business_3840x2160.mp4" type="video/mp4">
</video>

	<div class="loginContainer">
	<div id="login">
		<div class="loginContainer">
		<h1><img src="/Codenimo-login/wp-content/uploads/2024/10/cropped-Codenimo-Logo-512x512-1.png" alt=""></h1>
			<div class="loginContentContainer">
				<div class="loginContent">
				
					<h2>Welcome to Codenimo</h2>
...
function login_footer( $input_id = '' ) {
	...
	<div id="signup" class="active">
		...
		<?php echo do_shortcode('[custom_registration]'); ?>
			<p style="font-size: 12px;">Your account needs to be verified by the admin before you can log in after registering. Thank you for your patience!</p>
		</div>
	</div>
	</div>
